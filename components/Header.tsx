...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 sm:flex sm:items-center sm:justify-between">
      ...
      <nav className={(toogle ? 'block' : 'hidden') + ' sm:flex sm:items-center sm:px-4'}>
        <div className="px-2 pt-2 pb-5  border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
          <a
            className="rounded px-3 pt-1 block font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2"
            href="#">
            List your property
          </a>
          <a
            className="rounded px-3 pt-1 mt-1 block sm:mt-0 font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2"
            href="#">
            Trips
          </a>
          <a
        ...
        <div className="px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
          <div className="flex items-center">
            <Image
              className="w-10 h-10 object-cover rounded-full border-2 border-gray-600 sm:h-8 sm:w-8"
              src={woomanImg}
              alt="avatar"
              width="40px"
              height="40px"
